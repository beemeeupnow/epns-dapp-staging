...
function SpamBox({ currentTab }) {
    ...
    const { toggle } = useSelector((state: any) => state.notifications);
    const EPNS_DOMAIN = {
        name: "EPNS COMM V1",
        chainId: chainId,
                            ...
                            return (
                                <div key={`${message}+${title}`}>
                                    ...
                                    <NotificationItem
                                        ...
                                        isSpam
                                        isSubscribedFn={async () =>
                                            isSubscribedFn(subscribers)
                                        }
